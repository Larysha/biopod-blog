...
If you want to use the exact theme from this site, you're welcome to. The theme is [available on GitHub](https://github.com/Larysha/biopod-blog) for anyone to use and adapt.
...
Download or copy:
- [`biopod-theme.scss`](https://github.com/Larysha/biopod-blog/blob/main/biopod-theme.scss) (the theme file)
...
First create a place for your blog to "live" on your GitHub, then open your terminal where you project "lives" locally and type the following commands:
...
NB: make sure you have completed `quarto render` -> `git add .` -> `git commit -m "first commit"` -> `git push` 
and that as a result you have a deplyable site on you GitHub in the `/docs`  folder becuase otherwise deploy will fail
Also remember this sequence of commands becuase this is what you will do everytime you add a new post and want to update your site 
It's pretty simple - just remember you have to build locally with  `render` before GitHub pages can deploy
